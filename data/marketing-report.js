window.REPORT_GSJ_DATA = {
  "source": {
    ...
    "syncedAt": "13:22:44 25/5/2026",
    "sourceType": "google-sheet-csv"
  },
  "meta": {
    "title": "Bao cao Marketing giup theo doi truc quan, nang cao hieu suat",
    "subtitle": "Dashboard nay doc khoi Total trong sheet va chuan hoa thanh KPI thang, funnel va nhat ky ngay.",
    "activePeriod": "01/05 - 31/05",
    "defaultMonthKey": "05"
  },
  "summary": {
    "revenue": 342000000,
  ...
  "insights": [
    ...
    "Ty le chuyen doi L0/C3 hien tai dat 92.3%.",
    "Gia C3 dang o muc 133.624 ₫ va ARPU dat 24.428.571 ₫."
  ],
  "actions": [
    "Duy tri muc chi phi hien tai va uu tien ngan sach cho nhom co doanh thu on dinh.",
    "Gia C3 dang trong tam kiem soat, co the tiep tuc scale nhom hieu qua.",
    "Ty le L0/C3 tot, nen uu tien day them volume cho nhom chuyen doi cao.",
    "Doanh thu thang hien tai dang giam, can review cac ngay chi phi cao nhung RE bang 0."
  ]
};
